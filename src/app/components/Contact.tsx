...
export default function Contact(): React.JSX.Element {
    ...
    async function sendEmail(event: React.FormEvent<HTMLFormElement>): Promise<void> {
        ...
        try {
            const mail: EmailJSResponseStatus =
                await emailjs.send(
            ...
            if (mail.status === 200) alert("Email enviado com sucesso!")
            else throw new Error("Ocorreu um erro ao enviar o email. Por favor, tente novamente.")
        } catch (error: any) {
